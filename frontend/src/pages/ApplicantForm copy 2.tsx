...
const applicantSchema = z.object({
  ...
  totalMarks: z.number().min(0).max(50).default(0),
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold">{id ? 'Edit Applicant' : 'Add New Applicant'}</h1>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          {/* Appointment Details */}
          {/* CV Upload */}
          {/* The full structure remains same as your previous code but without syntax errors */}
